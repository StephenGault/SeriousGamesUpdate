...
public class RatingManager : MonoBehaviour
{
    ...
    public void EndGameBreach()
    {
        menu = GameObject.Find("ProgressManager");
        menu.GetComponent<ProgressManager>().newBreachRating = rating;
        menu.GetComponent<ProgressManager>().UpdateRating();
        StartCoroutine(fade());
    }

    public void EndGameInterrogation()
    {
        menu = GameObject.Find("ProgressManager");
        menu.GetComponent<ProgressManager>().newInterrogationRating = rating;
        menu.GetComponent<ProgressManager>().UpdateRating();
        StartCoroutine(fade());
    }
